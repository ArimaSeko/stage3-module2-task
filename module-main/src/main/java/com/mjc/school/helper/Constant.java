...
public class Constant {
    ...
    public static final String NEWS_ID_ENTER = "Enter news.properties id:";
    public static final String NEWS_TITLE_ENTER = "Enter news.properties title:";
    public static final String NEWS_CONTENT_ENTER = "Enter news.properties content.properties:";
